...
public record NodeSyncData(List<BlockPos> sapphirePositions, List<BlockPos> topazPositions, List<BlockPos> peridotPositions, List<BlockPos> sunstonePositions) {
    ...
    public NodeSyncData(FriendlyByteBuf buf) {
        ...
        this(sapphirePositions, routerPositions, peridotPositions, sunstonePositions);
    }
