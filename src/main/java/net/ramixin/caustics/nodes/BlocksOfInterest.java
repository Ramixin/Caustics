...
public record BlocksOfInterest(List<BlockPos> sapphireClusters, List<BlockPos> cinnabarClusters, List<BlockPos> peridotClusters, List<BlockPos> topazClusters, List<BlockPos> sunstoneClusters, List<BlockPos> seleniteClusters, List<BlockPos> tourmalineBlocks) {
    ...
    public static final Codec<BlocksOfInterest> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            BlockPos.CODEC.listOf().fieldOf("tourmalineBlocks").forGetter(BlocksOfInterest::tourmalineBlocks)
